...
const ConnectPanel = () => (
  <Reveal>
    <div className="connect">
      ...
      <p>
        For research collaborations, leadership opportunities, or community initiatives—or just to talk about climate policy, strategy, science, or Model United Nations—I'd love to hear from you.
      </p>
      <div className="cta-row">
  ...
  return (
    <>
      ...
      <section className="section">
        ...
        <MoreLink to="/awards">More Awards & Recognition</MoreLink>
      </section>
      ...
      <section className="section">
              <SectionHead title="Featured Projects" eyebrow="What I've Created" />
      ...
      <section className="section">
        <SectionHead title="Community Service" eyebrow="Service & Impact" />
        <Reveal>
        ...
        <MoreLink to="/volunteering">More about Community Service</MoreLink>
      </section>
...
export function Projects() {
  ...
  return (
    <section className="section">
      <PageHead title="Featured Projects" eyebrow="What I've Created" />
      <div className="grid-2">
        {PROJECTS.map((p, i) => (
...
export function Volunteering() {
  usePageMeta(`Community Service | ${SITE}`, "Founding a machine learning club, teaching summer band, and community volunteering.");
  return (
    <section className="section">
      <PageHead title="Community Service" eyebrow="Service & Impact" />
      <Reveal>
        <div className="vol-panel">
          <div className="vol-stats">
            {VOLUNTEER.stats.map((s) => (
...
export function Sports() {
  usePageMeta(`Beyond Academics | ${SITE}`, "Marching band, saxophone ensemble, concert band, hackathons, and game jams.");
  return (
    <section className="section">
      <PageHead title="Beyond Academics" eyebrow="Extracurricular Activities" />
